...
public interface InterfaceCoordenador extends Remote {
    ...
    /**
     * =================================================================================================================
     * Faz uma consulta de voos e hotéis para os dados fornecidos, e retorna os resultados em um objeto.
     ...
     * @param dataVolta  data do voo de volta e de saída do hotel (não é incluída reserva de hotel para a data de saída)
     ...
     * @throws RemoteException caso ocorra erro no RMI
     */
    ConjuntoPacote consultarPacotes(Cidade origem,
                                    Cidade destino,
                                    LocalDate dataIda,
                                    LocalDate dataVolta,
                                    int numQuartos,
     ...
     * @param dataVolta  data do voo de volta (dia seguinte à data de saída do hotel)
     ...
     * @throws RemoteException caso ocorra erro no RMI
     */
    boolean comprarPacote(int idVooIda,
                          int idVooVolta,
                          int idHotel,
                          LocalDate dataIda,
                          LocalDate dataVolta,

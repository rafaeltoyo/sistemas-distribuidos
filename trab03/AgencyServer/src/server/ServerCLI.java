...
public class ServerCLI {
    ...
    private static void popularServidor() {
        adicionarVoo("Curitiba", "Florianópolis", "2018-10-16", "100", "100,00");
        adicionarVoo("Florianópolis", "Curitiba", "2018-10-16", "100", "100,00");
        adicionarVoo("Curitiba", "Florianópolis", "2018-10-17", "100", "100,00");
        adicionarVoo("Florianópolis", "Curitiba", "2018-10-17", "100", "100,00");
        adicionarVoo("Curitiba", "Florianópolis", "2018-10-18", "100", "100,00");
        adicionarVoo("Florianópolis", "Curitiba", "2018-10-18", "100", "100,00");
        adicionarVoo("Curitiba", "Florianópolis", "2018-10-19", "100", "100,00");
        adicionarVoo("Florianópolis", "Curitiba", "2018-10-19", "100", "100,00");
        adicionarVoo("Curitiba", "Florianópolis", "2018-10-20", "100", "100,00");
        adicionarVoo("Florianópolis", "Curitiba", "2018-10-20", "100", "100,00");
        adicionarVoo("Curitiba", "São Paulo", "2018-10-16", "100", "100,00");
        adicionarVoo("São Paulo", "Curitiba", "2018-10-16", "100", "100,00");
        adicionarVoo("Curitiba", "São Paulo", "2018-10-17", "100", "100,00");
        adicionarVoo("São Paulo", "Curitiba", "2018-10-17", "100", "100,00");
        adicionarVoo("Curitiba", "São Paulo", "2018-10-18", "100", "100,00");
        adicionarVoo("São Paulo", "Curitiba", "2018-10-18", "100", "100,00");
        adicionarVoo("Curitiba", "São Paulo", "2018-10-19", "100", "100,00");
        adicionarVoo("São Paulo", "Curitiba", "2018-10-19", "100", "100,00");
        adicionarVoo("Curitiba", "São Paulo", "2018-10-20", "100", "100,00");
        adicionarVoo("São Paulo", "Curitiba", "2018-10-20", "100", "100,00");

        adicionarHotel("Hotel Peru", "Florianópolis", "20", "100,00");
        adicionarHospedagem("0", "2018-10-16", "2018-10-20");
        adicionarHotel("Hotel Pato", "Florianópolis", "30", "100,00");
        adicionarHospedagem("1", "2018-10-16", "2018-10-20");
        adicionarHotel("Hotel Galinha", "Florianópolis", "15", "100,00");
        adicionarHospedagem("2", "2018-10-16", "2018-10-20");
        adicionarHotel("Hotel Weeb", "Curitiba", "20", "100,00");
        adicionarHospedagem("3", "2018-10-16", "2018-10-20");
        adicionarHotel("Hotel Noob", "Curitiba", "30", "100,00");
        adicionarHospedagem("4", "2018-10-16", "2018-10-20");
        adicionarHotel("Hotel Bispo", "Curitiba", "15", "100,00");
        adicionarHospedagem("5", "2018-10-16", "2018-10-20");
        adicionarHotel("Hotel Pereira", "São Paulo", "20", "100,00");
        adicionarHospedagem("6", "2018-10-16", "2018-10-20");
        adicionarHotel("Hotel Madoka", "São Paulo", "30", "100,00");
        adicionarHospedagem("7", "2018-10-16", "2018-10-20");
        adicionarHotel("Hotel Homura", "São Paulo", "15", "100,00");
    ...
    private static void mostrarMenu() {
        System.out.println("Comandos:\n" +
                "  -add voo <origem> <destino> <data> <num_poltronas> <preco>\n" +
                ...
                "  -add hotel <nome> <cidade> <num_quartos> <preco>\n" +
    ...
    private static void processarComando(String comando) {
        ...
        if (tokens.size() == 7 && tokens.get(1).equals("voo")) {
            deuboa = adicionarVoo(tokens.get(2), tokens.get(3), tokens.get(4), tokens.get(5), tokens.get(6));
        }
        else if (tokens.size() == 6 && tokens.get(1).equals("hotel")) {
            deuboa = adicionarHotel(tokens.get(2), tokens.get(3), tokens.get(4), tokens.get(5));
        }
     ...
     */
    private static boolean adicionarVoo(String origemStr, String destinoStr, String dataStr, String numPoltronasStr, String precoStr) {
        Cidade origem = null;
        Cidade destino = null;
        ...
        // Converte o campo <preco> para BigDecimal
        BigDecimal preco;
        try {
            preco = (BigDecimal) df.parse(precoStr);
        }
        ...
        // Agora deu boa
        Voo voo = new Voo(origem, destino, data, numPoltronas, Dinheiro.reais(preco));
     ...
     */
    private static boolean adicionarHotel(String nomeStr, String cidadeStr, String numQuartosStr, String precoStr) {
        if (nomeStr == null) {
            return false;
        }
        ...
        // Agora deu boa
        Hotel hotel = new Hotel(nomeStr, cidade, numQuartos, Dinheiro.reais(preco));

...
public class MessageDecoderThread extends Thread {
    ...
    public void run() {
        ...
        while (!Thread.currentThread().isInterrupted()) {
            JSONObject jsonMsg = messages.peek();
    ...
    private void processJoinMessage(JSONObject jsonMsg) throws IOException {
        ...
        JoinResponse joinResponse = new JoinResponse(user, senderId);
